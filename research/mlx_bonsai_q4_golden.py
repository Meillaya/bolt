...
same prompt used by bolt's bonsai_q4_golden.zig, and prints
the output token IDs as a Zig array literal for pasting into
the golden test.

This is the ground-truth reference — if MLX and bolt disagree, inspect the engine gate and local asset contract.

Usage:
  python research/mlx_bonsai_q4_golden.py
  python research/mlx_bonsai_q4_golden.py --model /path/to/qwen3-1.7b-q4
  python research/mlx_bonsai_q4_golden.py --max-tokens 40
"""
...
# Model directory: prefer the bolt data/ copy, fall back
