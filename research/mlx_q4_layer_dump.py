...
in the forward pass for comparison with bolt diagnostics.
...
Usage:
  python research/mlx_q4_layer_dump.py
  python research/mlx_q4_layer_dump.py --model /path/to/qwen3-1.7b-q4
"""
