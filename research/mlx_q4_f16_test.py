...
entire forward pass in bfloat16.  bolt converts everything to
float16 and computes in float16.  This script tests whether float16
computation is the root cause of bolt's wrong output.
...
Usage:
  python research/mlx_q4_f16_test.py
  python research/mlx_q4_f16_test.py --model /path/to/qwen3-1.7b-q4
"""
...
def main():
    ...
    prompt_ids = build_bolt_prompt(tokenizer)
